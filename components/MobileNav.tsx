...
const MobileNav = (props: INav) => {
  return (
    <div
      className={`sm:hidden fixed w-full h-screen right-0 bg-gray-200 dark:bg-gray-800/30 backdrop-blur-md bg-white/30 z-50 transform ease-in-out duration-300 ${
